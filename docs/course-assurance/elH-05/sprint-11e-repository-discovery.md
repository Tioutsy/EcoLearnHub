# Sprint 11E Repository Discovery — ELH-05 Sustainable Procurement

## 1. Executive Summary
This document records the exact runtime architecture, files, database tables, and seeder scripts controlling **ELH-05 — Sustainable Procurement**.
...
- **Seeder & Canonical Definition**: `artifacts/api-server/src/lib/ensureSustainableProcurementCourse.ts` & `ensureCatalogueSkeletons.ts` (Executes during server startup to seed/sync ELH-05 content blocks, whole-life value principles, ISO 20400 standards references, supplier evidence requirements, anti-bribery governance, scenarios, and quiz questions).
...
## 3. Structural Summary of ELH-05
- **Course Code**: `ELH-05`
