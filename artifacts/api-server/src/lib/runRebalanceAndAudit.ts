...
async function main() {
  console.log("Ensuring database seeders are initialized...");
  ...
  console.log("\nExecuting rebalanceAllQuizAnswers()...");
  await rebalanceAllQuizAnswers();

  console.log("\nRunning Post-Rebalance Audit...\n");
  const audit = await auditFullCatalogueQuizDistribution();
  console.log("=== POST-REBALANCE CATALOGUE QUIZ AUDIT RESULTS ===");
  ...
  console.log("\nPer-Course Post-Rebalance Breakdown:");
