...
export async function ensureChallenges(): Promise<void> {
  try {
    ...
    const canonicalChallenges: any[] = [
      ...
      {
        code: "ELH-CH-11",
        slug: "reduce-single-use-plastics",
        title: "Reduce Single-Use Plastics",
        summary: "Identify and swap 3 single-use plastic items for reusable alternatives in the office lunchroom.",
        description: "Identify and swap 3 single-use plastic items for reusable alternatives in the office lunchroom.",
        ...
        icon: "recycle",
        theme: "amber",
        focus: "plastics replaced",
        unit: "plastics replaced",
        goalTarget: 3,
        instructions: "1. Audit your daily kitchen/canteen activities for plastic packaging.\n2. Work with the facilities or team to replace single-use plastic cups/plates/cutlery with glass or metal reusable items.\n3. Verify that teammates use the new items for 5 consecutive days.",
        evidencePrompt: "Please describe the single-use plastic items you targeted, the reusable alternatives deployed, and the feedback from teammates.",
        startDate: new Date("2025-01-01T00:00:00Z"),
        endDate: new Date("2030-01-01T00:00:00Z"),
        orderIndex: 11,
      },
      {
        code: "ELH-CH-12",
        slug: "green-travel-audit",
        title: "Green Travel Audit",
        summary: "Record and review green travel habits for a week.",
        description: "Record and review green travel habits for a week.",
        category: "Procurement",
        linkedCourseSlug: "sustainable-procurement",
        durationLabel: "1 week",
        points: 10,
        ...
        unit: "days audited",
        goalTarget: 5,
        instructions: "1. Log your daily commute method for 5 consecutive workdays.\n2. Calculate the carbon footprint of your commute using standard commuter tools.\n3. Propose a carpooling or remote-work recommendation to your manager.",
        evidencePrompt: "Please summarize your commute audit findings, estimated travel footprint savings, and the commuter suggestion you discussed with your team.",
        startDate: new Date("2025-01-01T00:00:00Z"),
        endDate: new Date("2030-01-01T00:00:00Z"),
        orderIndex: 12,
      },
